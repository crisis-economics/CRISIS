...
public class InterbankMarketTest {
     ...
     * @author  olaf
     */
    private class MyBorrower extends Bank implements InterbankBorrower, Buyer {
     ...
     * @author  olaf
     */
    private class MyLender extends Bank implements Lender, LoanSeller, Buyer {
    ...
    public void setUp() throws Exception {
        ...
        simState.start();
        market = new InterbankLoanMarket(new InterbankNetwork());
        lender = new MyLender(market,1500);
        borrower = new MyBorrower(market,1000);
    }
    ...
    public final void testGetInstrument() {
        Assert.assertNotNull(market.getInstrument(tau));
    }
    ...
    public final void testStep() {
        long steps = 0;
        System.out.println("Steps: " + steps + "\tTime: " + simState.schedule.getTime() + "\tLender: " + lender.funds + "\tBorrower: " + borrower.funds + "\tVolume: " + market.getInstrument(tau).getBuyVolume());
    ...
    static public void main(String[] args) {
       System.out.println("Test: InterbankMarketTest..");
       InterbankMarketTest test = new InterbankMarketTest();
       try {
          test.setUp();
       ...
       System.out.println("InterbankMarketTest pass.");
    }
}
