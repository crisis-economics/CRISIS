...
/**
  * A unit test structure for the {@link DiagonalInputOutputMatrixFactory} class.
  * 
  * @author phillips
  */
public class TestDiagonalInputOutputMatrixFactory {
   ...
   /**
     ...
     * {@link DiagonalInputOutputMatrixFactory} factory. The resulting
     * matrix values are tested against predicted values.
     */
   public void testDiaongalInputOutputMatrixFactory() {
      { // 1 x 1 matrix case
         final List<String>
            sectorNames = Arrays.asList("A");
         final InputOutputMatrixFactory
            factory = new DiagonalInputOutputMatrixFactory(
   ...
   static public void main(String[] args) {
      try {
         final TestDiagonalInputOutputMatrixFactory
            test = new TestDiagonalInputOutputMatrixFactory();
         test.setUp();
         test.testDiaongalInputOutputMatrixFactory();
         test.tearDown();
      }
