...
/**
  * A unit test structure for the {@link HomogeneousInputOutputMatrixFactory} class.
  * 
  * @author phillips
  */
public class TestHomogeneousInputOutputMatrixFactory {
   ...
   /**
     ...
     * {@link HomogeneousInputOutputMatrixFactory} factory. The resulting
     * matrix values are tested against predicted values.
     */
   public void testHomogeneousInputOutputMatrixFactory() {
      { // 1 x 1 matrix case
         final List<String>
            sectorNames = Arrays.asList("A");
         final InputOutputMatrixFactory
            factory = new HomogeneousInputOutputMatrixFactory(
               new ManualSectorNameProvider(sectorNames));
   ...
   static public void main(String[] args) {
      try {
         final TestHomogeneousInputOutputMatrixFactory
            test = new TestHomogeneousInputOutputMatrixFactory();
         test.setUp();
         test.testHomogeneousInputOutputMatrixFactory();
         test.tearDown();
      }
