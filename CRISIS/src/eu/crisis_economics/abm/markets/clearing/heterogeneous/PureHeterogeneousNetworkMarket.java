...
/** 
  ...
  * a single resource in pure homogeneous mode.
  * 
  * @author phillips
  */
public final class PureHeterogeneousNetworkMarket
   extends CompleteNetworkMarket {
   
   public PureHeterogeneousNetworkMarket(
   ...
   protected MixedClearingNetwork buildNetwork() {
      ...
      for(PureHomogeneousNetworkMarket.Participant buyer : getBuyerParticipants()) {
         for(PureHomogeneousNetworkMarket.Participant seller : getSellerParticipants()) {
            builder.addEdge(
               buyer.getUniqueID(),
               seller.getUniqueID(),
