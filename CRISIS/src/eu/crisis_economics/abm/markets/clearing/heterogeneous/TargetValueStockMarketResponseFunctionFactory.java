...
/**
  ...
  * should hold following market clearing for the stock instrument.
  * 
  * @author phillips
  */
public final class TargetValueStockMarketResponseFunctionFactory
   ...
   /**
     * Create a {@link TargetValueStockMarketResponseFunctionFactory}
     ...
     * stocks following market clearing.
     * 
     * @param market
     ...
     */
   @Inject
   public TargetValueStockMarketResponseFunctionFactory(
   @Assisted
   ...
   public MarketResponseFunction operateOn(final PortfolioFund participant) {
      final double
         targetInvestment =
            participant.getDesiredStockInvestmentIn(market.getStockReleaserName()),
