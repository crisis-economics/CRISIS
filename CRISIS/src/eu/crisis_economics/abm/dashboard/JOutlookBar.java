...
public class JOutlookBar extends JPanel implements ActionListener {
	...
	/**
	 * Creates a new vertical JOutlookBar; after which you should make repeated calls to
	 * addBar() for each bar
	 */
	public JOutlookBar() {
		init();
	...
	/**
	 * Creates a new JOutlookBar with the given orientation; after which you should make repeated calls to
	 * addBar() for each bar
	 */
	public JOutlookBar(final boolean vertical){
	...
	public void addBar(String name, JComponent component) {
		BarInfo barInfo = new BarInfo(name, component, vertical);
	...
	public void addBar(String name, Icon icon, JComponent component) {
		BarInfo barInfo = new BarInfo(name, icon, component, vertical);
		barInfo.getButton().addActionListener(this);
		this.bars.put(name, barInfo);
		render();
	}
