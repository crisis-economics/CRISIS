...
import eu.crisis_economics.abm.bank.strategies.MarketMakerStrategy;
import eu.crisis_economics.abm.simulation.injection.factories.BankStrategyFactory;

public final class MarketMaker extends StrategyBank {
   public MarketMaker(
      ...
      super(
         ...
         new BankStrategyFactory() {
            ...
            public BankStrategy create(StrategyBank bank) {
               return new MarketMakerStrategy(bank);
            }
         }
      );
   }
