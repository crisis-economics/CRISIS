...
import eu.crisis_economics.abm.bank.strategies.RandomBankStrategy;
import eu.crisis_economics.abm.simulation.injection.factories.BankStrategyFactory;

/**
 * @author Tamás Máhr
 */
public class RandomStrategyBank extends StrategyBank {
   
   public RandomStrategyBank(
      ...
      super(
         ...
         new BankStrategyFactory() {
            ...
            public BankStrategy create(final StrategyBank bank) {
               return new RandomBankStrategy(bank, orderSizeDistribution,
                  orderPriceDistribution, stockInstrumentDistribution);
            }
         }
      );
   }
