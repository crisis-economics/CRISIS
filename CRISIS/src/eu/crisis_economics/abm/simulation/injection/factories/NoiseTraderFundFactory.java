...
/**
  * An interface for a {@link NoiseTraderFund} factory. This interface is used
  * by the dependency injector. It is not necessary for this interface to be 
  * implemented.
  * 
  * @author phillips
  */
public interface NoiseTraderFundFactory extends FundFactory {
   /**
     ...
     */
   public NoiseTraderFund create(DepositHolder depositHolder);
}
