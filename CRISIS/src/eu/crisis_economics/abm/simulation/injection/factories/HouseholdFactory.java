...
/**
  * An interface for a {@link Household} factory. This interface is used
...
public interface HouseholdFactory {
   /**
     * Create a {@link DepositingHousehold} object.
     * 
     * @param depositHolder
     *        The {@link DepositHolder} of the {@link Household}.
     */
   public DepositingHousehold create(DepositHolder depositHolder);
}
