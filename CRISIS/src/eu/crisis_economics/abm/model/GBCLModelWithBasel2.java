...
/**
  ...
  * @author phillips
  */
public class GBCLModelWithBasel2 extends AbstractModel {
   ...
   public GBCLModelWithBasel2() {
      this(1L);
   }
   
   @ConfigurationComponent(
      DisplayName = "Configure GCBL Model With Basel II..",
      Description =
         "An economy with a graded commercial loan clearing market, gilts, bonds, and "
       + "Basel II financial leverage regulation."
      )
   protected static class GBCLConfiguration {
      ...
      public GBCLConfiguration() {
         basel2Regulation.setPermanentLeverageScalingFactor(.075 * .7);
      }
   }
   ...
   public GBCLModelWithBasel2(long seed) {
      super(seed);
   }
   ...
   public static void main(final String[] argv) {
      doLoop(GBCLModelWithBasel2.class, argv);
