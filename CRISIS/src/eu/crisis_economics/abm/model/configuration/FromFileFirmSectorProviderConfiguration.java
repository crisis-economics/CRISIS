...
import eu.crisis_economics.abm.firm.FromFileFirmSectorProvider;
...
/**
  * A configuration component for the {@link FromFileFirmSectorProviderConfiguration} class.
  * 
  * @author phillips
  */
@ConfigurationComponent(
   DisplayName = "Sector Names From File"
   )
public final class FromFileFirmSectorProviderConfiguration
   extends AbstractFirmSectorProviderConfiguration implements FirmSectorProviderConfiguration {
   
   private static final long serialVersionUID = -9197728704570221840L;
   ...
   public FromFileFirmSectorProviderConfiguration() { }
   
   /**
     * Create a {@link FromFileFirmSectorProviderConfiguration} object with
     * custom parameters.
     * 
     * @param filename
   ...
   protected void addBindings() {
      ...
      bind(FirmSectorProvider.class)
         .to(FromFileFirmSectorProvider.class)
         .in(Singleton.class);
      super.addBindings();
   }
}