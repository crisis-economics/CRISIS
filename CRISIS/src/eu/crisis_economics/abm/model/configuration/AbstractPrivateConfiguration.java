...
/**
  ...
  * This implementation is a {@link PrivateModule} which does not, unless instructed
  * by the {@link #expose} method, expose its class bindings to any parent modules.
  * <br><br>
  * 
  ...
  * @author phillips
  */
public abstract class AbstractPrivateConfiguration
   extends PrivateModule implements ComponentConfiguration {
   
   private static final long serialVersionUID = -5051487257362425263L;
   
   private Scoped
      scoped;
   
   /**
     * Create a {@link AbstractPrivateConfiguration} object with no custom scope.
     */
   protected AbstractPrivateConfiguration() {
