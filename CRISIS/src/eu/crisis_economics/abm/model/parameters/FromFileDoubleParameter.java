...
/**
  ...
  * exactly one {@link Double} record per line.<br><br>
  * 
  ...
  * with {@code 3} possible values. The values {@code 1.0}, {@code 4.0},
  * {@code 9.0} will be returned, in that order, for each call to
  * {@link #get()}. The fourth call to {@link #get()} raises {@link IllegalStateException}.
  * 
  * @author phillips
  */
public final class FromFileDoubleParameter
   extends AbstractFromFileParameter<Double> {
   
   /**
     * Create a {@link FromFileDoubleParameter} object using the specified file.<br><br>
     * 
     * See also {@link AbstractFromFileParameter} and {@link FromFileDoubleParameter}.
     */
   @Inject
   public FromFileDoubleParameter(
   ...
   /**
     * Parse the input {@link String} as a {@link Double}.
     */
   @Override
   Double parse(final String line) {
