...
/**
  ...
  * to the bailout bankruptcy resolution case.
  * 
  * @author phillips
  */
public class BankBailoutModel extends AbstractBankBankruptcyModel {
   
   public BankBailoutModel() {
      super(1L);
   }
   
   public BankBailoutModel(long seed) {
      super(seed);
   }
   ...
   protected MasterModelConfiguration configureBankruptcyPolicy(
      ...
      financialSubeconomy.setBankBankruptcyResolutionPolicy(
         new BailoutBankBankruptcyPolicyConfiguration());
