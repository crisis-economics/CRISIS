...
/**
  ...
  * generates a homogeneous {@link InputOutputMatrix} with no random elements.<br><br>
  ...
  * @author phillips
  */
public final class HomogeneousInputOutputMatrixFactory implements InputOutputMatrixFactory {
   
   private List<String>
      sectorNames;
   
   /**
     * Create a {@link HomogeneousInputOutputMatrixFactory} object with custom parameters.
     * 
     * @param sectorNames
     ...
     */
   @Inject
   public HomogeneousInputOutputMatrixFactory(
   ...
   public String toString() {
      return "Homogeneous Input-Output Matrix Factory.";
   }
}
