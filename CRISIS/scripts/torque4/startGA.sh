...
java -Xmx1024m -classpath $CLASSPATH -Dscheduler.type=torque4 -Dscripts.dir=$SCRIPTDIR eu.crisis_economics.abm.dashboard.cluster.ClusterMain --configFile=$CONFIGFILE $ALLOWED_TIME
