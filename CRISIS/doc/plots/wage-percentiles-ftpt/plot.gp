...
# Part--Time/Full--Time Employee Earning Percentiles (10%, 25%, 50%, 75% and
# 90% Boundaries)
# 
...
set terminal epslatex color size 7,8 'Serif,10' dl 2 linewidth 2
...
#
# Add a data source for UK part-time employee earning percentiles for
# inclusion in /doc/CRISIS.pdf:
#
